...
export default function Project() {
  return (
    <Container>
      ...
      <p>
        ‘Madhumalti’ is a short film that explores the theme of love. The film
        talks about Anandita who finds colours in her pale life after meeting
        Tara. Here’s the link to the film.
        <br />
        <br />
        Check it out !!
      </p>
